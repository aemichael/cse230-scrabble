...
next :: Scrabble -> Board.Result Board.Board -> Player.Player -> Either (Board.Result ()) Scrabble
next s Board.Retry     _  = Right s
next s (Board.Cont b') p'  = Right (s { scrabbleBoard = b', scrabblePlayer = p'})
